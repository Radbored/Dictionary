...
public class ConsoleMenu implements Menu {
  ...
  private void removeValue(Dictionary dictionary, String key) throws Exception {
    System.out.println(dictionary.remove(key));
  }
  private void getValue(Dictionary dictionary, String key) throws Exception {
    System.out.println(dictionary.get(key));
  }
  private void putValue(Dictionary dictionary, String key, String value) throws Exception {
